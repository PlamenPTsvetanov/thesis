...
class Setup:
    ...
    paths = {
        'WORKSPACE_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace'),
        'SCRIPTS_PATH': os.path.join(os.getcwd(), "cv_process", 'scripts'),
        'APIMODEL_PATH': os.path.join(os.getcwd(), "cv_process", 'models'),
        'ANNOTATION_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'annotations'),
        'IMAGE_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'images'),
        'MODEL_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'models'),
        'PRETRAINED_MODEL_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'pre-trained-model'),
        'CHECKPOINT_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'models', CUSTOM_MODEL_NAME),
        'OUTPUT_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'models', CUSTOM_MODEL_NAME, 'export'),
        'TFJS_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'models', CUSTOM_MODEL_NAME, 'tfjsexport'),
        'TFLITE_PATH': os.path.join(os.getcwd(), "cv_process", 'workspace', 'models', CUSTOM_MODEL_NAME, 'tfliteexport'),
        'PROTOC_PATH': os.path.join(os.getcwd(), "cv_process", 'protoc')
    }

    files = {
        'PIPELINE_CONFIG': os.path.join(os.getcwd(), "cv_process", 'workspace', 'models', CUSTOM_MODEL_NAME, 'pipeline.config'),
